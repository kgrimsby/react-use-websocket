...
var bindMessageHandler = function (webSocketInstance, optionsRef, setLastMessage) {
    webSocketInstance.onmessage = function (message) { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = optionsRef.current.messageTransformer;
                    if (!_a) return [3 /*break*/, 2];
                    return [4 /*yield*/, optionsRef.current.messageTransformer(message)];
                case 1:
                    _a = (_b.sent());
                    _b.label = 2;
                case 2:
